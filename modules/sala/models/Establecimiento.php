 ...
 * @property Catalogoestablecimiento $padre
 * @property Catalogoestablecimiento[] $catalogoestablecimientos
 * @property Catalogoestablecimiento $asic
 * @property Catalogoestablecimiento[] $catalogoestablecimientos0
 ...
 */
class Catalogoestablecimiento extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            ...
            [['id_padre'], 'exist', 'skipOnError' => true, 'targetClass' => Catalogoestablecimiento::className(), 'targetAttribute' => ['id_padre' => 'id']],
            [['id_asic'], 'exist', 'skipOnError' => true, 'targetClass' => Catalogoestablecimiento::className(), 'targetAttribute' => ['id_asic' => 'id']],
    ...
    {
        return $this->hasOne(Catalogoestablecimiento::className(), ['id' => 'id_padre']);
    }

    /**
     * @return \yii\db\ActiveQuery
     */
    public function getCatalogoestablecimientos()
    {
        return $this->hasMany(Catalogoestablecimiento::className(), ['id_padre' => 'id']);
    }
    ...
    {
        return $this->hasOne(Catalogoestablecimiento::className(), ['id' => 'id_asic']);
    }

    /**
     * @return \yii\db\ActiveQuery
     */
    public function getCatalogoestablecimientos0()
    {
        return $this->hasMany(Catalogoestablecimiento::className(), ['id_asic' => 'id']);
    }
    ...
    {
        return $this->hasMany(Novedades::className(), ['cod_establecimiento_salud' => 'id']);
    }
    ...
    {
        return $this->hasMany(MedicosSegunUbicacion::className(), ['id_establecimiento' => 'id']);
    }
}
