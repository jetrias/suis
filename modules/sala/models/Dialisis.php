...
class Dialisis extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'esta_conectado_planta_electrica_del_hospital' => Yii::t('app', 'Esta Conectado a la Planta Electrica Del Hospital?'),
            ...
            'planta_electrica_aceite' => Yii::t('app', 'Necesita Aceite ls Planta Electrica?'),
            ...
            'planta_electrica_dissel' => Yii::t('app', 'Requiere Diesel Planta Electrica?'),
            'planta_electrica_cantidad_dissel_requerido' => Yii::t('app', ' Cantidad Dissel Requerido Planta Electrica (lts)'),
            ...
            'planta_electrica_nivel_dissel_restante' => Yii::t('app', 'Nivel Diesel Restante Planta Electrica'),
            ...
            'capacidad_tanque' => Yii::t('app', 'Capacidad Tanque (lts)'),
