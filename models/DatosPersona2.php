  ...
  public $municipio;
    ...
    public function rules()
    {
        return [
            ...
            [['id_nacionalidad', 'id_parroquia', 'id_sexo', 'cedula', 'id_comunidad', 'nro_hijo'], 'integer'],
            [['fecha_nac'], 'safe'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'carnet_patria' => Yii::t('app', 'Carnet Patria'),
            'codigo_carnet' => Yii::t('app', 'Codigo Carnet'),
            'serial_carnet' => Yii::t('app', 'Serial Carnet'),
            'id_comunidad' => Yii::t('app', 'Id Comunidad'),
            'nro_hijo' => Yii::t('app', 'Nro Hijo'),
        ];
    }
